...
const Sidebar = () => {
    return (
        <div className="md:w-2/5 xl:w-1/5 bg-gray-800">
            <div className="p-6">
                <p className="uppercase text-white text-2xl traking-wide text-center font-bold">RestaurantApp</p>

                <p className="mt-1 text-gray-600">Administra tu restaurante en las siguientes opciones:</p>
